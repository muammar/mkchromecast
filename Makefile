...
debug:
	...
	cp -R /usr/local/Cellar/qt/5.9.0/plugins dist/Mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/qt/5.9.0/bin/macdeployqt dist/Mkchromecast.app
...
deploy:
	...
	python3 setup.py py2app
	cp -R /usr/local/Cellar/qt/5.9.0/plugins dist/Mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/qt/5.9.0/bin/macdeployqt dist/Mkchromecast.app -dmg
