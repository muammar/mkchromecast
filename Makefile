...
debug:
	...
	cp -R /usr/local/Cellar/pyqt/5.8.0_1/plugins dist/mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/pyqt/5.8.0_1/bin/macdeployqt dist/mkchromecast.app
...
deploy:
	...
	python3 setup.py py2app
	cp -R /usr/local/Cellar/pyqt/5.8.0_1/plugins dist/mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/pyqt/5.8.0_1/bin/macdeployqt dist/mkchromecast.app -dmg
