...
debug:
	...
	cp -R /usr/local/Cellar/qt5/5.6.1/plugins dist/mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/qt5/5.6.1/bin/macdeployqt dist/mkchromecast.app
...
deploy:
	...
	python3 setup.py py2app
	cp -R /usr/local/Cellar/qt5/5.6.1/plugins dist/mkchromecast.app/Contents/PlugIns
	/usr/local/Cellar/qt5/5.6.1/bin/macdeployqt dist/mkchromecast.app -dmg
