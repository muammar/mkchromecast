...
if (len(sys.argv) > 1):
	...
	print('Optionally, you can provide the language (3 lowercase letters) of the '
			'lyrics and a description')
	sys.exit()
...
tags[u"USLT::'"+TEXT_LANG+"'"] = (USLT(encoding=3, lang=TEXT_LANG,
										desc=TEXT_DESC, text=lyrics))
