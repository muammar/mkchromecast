...
<html lang="en">
<head>
    <title>Code coverage report for urlgrey/lib/urlgrey.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">urlgrey/lib/urlgrey.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.49% <small>(223 / 236)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">83.19% <small>(94 / 113)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.55% <small>(28 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.22% <small>(219 / 230)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">urlgrey/lib/</a> &#187; urlgrey.js</div>
</div>
<div class="body">
...
433
434
435</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cstat-no" title="statement not covered" >    defaultUrl = window.location.href.toString();</span>
  }
...
var argsArray = function(obj){
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (Array.isArray(obj)) <span class="cstat-no" title="statement not covered" >return slice.call(obj);</span>
    var args = [];
...
var UrlGrey = function(url){
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (!url &amp;&amp; isBrowser){
<span class="cstat-no" title="statement not covered" >    url = window.location.href.toString();</span>
  }
  this.url = url;
  this._parsed = null;
};
...
UrlGrey.prototype.parsed = function(){
  if (!this._parsed){
    ...
    p.username = ''; 
    p.password = '';
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (p.protocol !== 'file'){
    ...
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (isBrowser){
<span class="cstat-no" title="statement not covered" >      p.hostname = p.hostname || defaults.hostname;</span>
    }
  }
&nbsp;
...
UrlGrey.prototype.extendedPath = function(url){
  if (url){
    ...
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (p.hash){
      p.hash = p.hash.substring(1);
    }
    ...
    var href = this.path();
    href += this.queryString() ? '?' + this.queryString() : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    href += this.hash() ? '#' + this.hash() : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    return href;
  }
};
&nbsp;
...
&nbsp;
  // setter
  if (num){
    <span class="missing-if-branch" title="if path not taken"" >I</span>if (this.protocol() === 'file'){
<span class="cstat-no" title="statement not covered" >      throw new Error("file urls don't have ports");</span>
    }
    var obj = new UrlGrey(this.toString());
...
<span class="branch-2 cbranch-no" title="branch not covered" >        default : <span class="cstat-no" title="statement not covered" >return null;</span></span>
      }
  }
...
UrlGrey.prototype.query = function(mergeObject){
  ...
  if (!mergeObject){
    ...
    <span class="missing-if-branch" title="else path not taken"" >E</span>if (!!parsed.search){
...
<span class="cstat-no" title="statement not covered" >    return {};</span>
    ...
    objectEach(mergeObject, function(v, k){
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (v === null){
<span class="cstat-no" title="statement not covered" >        delete oldQuery[k];</span>
      } else {
        oldQuery[k] = v;
      }
    });
...
UrlGrey.prototype.toString = function(){
  ...
  <span class="missing-if-branch" title="else path not taken"" >E</span>if (this.protocol() !== 'file'){
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Nov 26 2013 06:53:20 GMT-0800 (PST)</div>
</div>
